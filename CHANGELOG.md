...
- Hidden mode that sprinkles Linkin Park lyrics into the Activity
  and Top Queries snapshots. Opt-in. Default off, no overhead for
  anyone not setting the flag.
